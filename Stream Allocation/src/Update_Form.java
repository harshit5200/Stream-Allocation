...
public class Update_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 63, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 104, 99, 250));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(62, 493, -1, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel1.setText("ROLL NO");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(154, 131, 50, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel4.setText("SECTION");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(154, 239, -1, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel3.setText("CLASS");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 201, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("NAME");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(154, 166, -1, -1));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 166, 99, -1));
        getContentPane().add(txtCl, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 198, 99, -1));
        getContentPane().add(txtSec, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 236, 99, -1));
        ...
        getContentPane().add(txtRno, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 128, 99, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel8.setText("PERCENTAGE");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(154, 281, -1, -1));
        ...
        getContentPane().add(txtPer, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 278, 99, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("SST MARKS");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 160, -1, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setText("SCIENCE MARKS");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 128, -1, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel7.setText("TOTAL MARKS");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 303, -1, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel11.setText("MATHS MARKS");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 195, -1, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel9.setText("GRADE");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 341, -1, -1));
        ...
        getContentPane().add(txtGrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 338, 70, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(458, 493, -1, -1));

        txtTM.setEditable(false);
        getContentPane().add(txtTM, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 300, 70, -1));
        ...
        getContentPane().add(txtsst, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 159, 70, -1));
        getContentPane().add(txtscience, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 128, 70, -1));
        getContentPane().add(txtMM, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 192, 70, -1));
        ...
        getContentPane().add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(629, 488, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel10.setText("PREFFERED STREAM");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(154, 349, -1, -1));
        getContentPane().add(txtPS, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 346, 99, -1));
        ...
        getContentPane().add(btnCal, new org.netbeans.lib.awtextra.AbsoluteConstraints(261, 493, -1, -1));

        jLabel12.setFont(new java.awt.Font("Comic Sans MS", 1, 24)); // NOI18N
        jLabel12.setText("UPDATE FORM");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 20, -1, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel13.setText("ENGLISH MARKS ");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 233, -1, -1));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setText("HINDI MARKS");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 265, -1, -1));
        ...
        getContentPane().add(txteng, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 230, 70, -1));
        getContentPane().add(txthin, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 262, 70, -1));
